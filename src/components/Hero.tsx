  ...
  return <section className="relative min-h-[600px] lg:min-h-[700px] flex items-center">
      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="max-w-3xl">
          ...
          <p className="text-xl md:text-2xl text-lime font-heading font-semibold mb-4">
            Nordsjælland • Sjælland • København
          </p>
          
          <p className="text-2xl md:text-3xl text-white font-heading font-bold mb-8 bg-lime/20 backdrop-blur-sm inline-block px-6 py-3 rounded-lg">10% på udvalgte jobs resten af 2025!</p>
          ...
          <div className="flex flex-col sm:flex-row gap-4">
            ...
            <Button asChild size="lg" className="bg-lime hover:bg-lime/90 text-foreground text-lg font-heading font-semibold">
